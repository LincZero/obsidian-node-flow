<template>
  <div class="main-bar menus-1">
    ...
    <div class="menu-1" style="padding: 0 16px; font-weight:bold; font-size: 16px; color: #11b981;">EditableCodeblock Online</div>

    <!-- Right -->
    <div class="menu-1" style="padding: 0 28px 0 16px; font-weight:bold; font-size: 16px; float: right;">
      <a href="https://github.com/LincZero/obsidian-shiki-plugin/tree/master">
    ...
    <div class="menu-1" style="padding: 0 16px; font-weight:bold; font-size: 16px; float: right;">
      <a href="https://linczero.github.io/MdNote_Public/ProductDoc/AnyBlock/">在线文档</a>
    </div> -->
    <div class="menu-1" style="padding: 0 16px; font-weight:bold; font-size: 16px; float: right"
