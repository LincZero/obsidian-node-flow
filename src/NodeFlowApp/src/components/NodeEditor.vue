...
<template>
  <div class="node-editor">
    <div v-if="nfNode_current != null" style="margin: 0 0 12px; padding: 0;">
      <ItemNode2 :id="nfNode_current.nodeId" :data="nfNode_current.nfData"></ItemNode2>
    </div>
    <textarea v-if="nfNode_current" spellcheck="false" class="item" v-model="nfNode_current.nfStr"></textarea>
